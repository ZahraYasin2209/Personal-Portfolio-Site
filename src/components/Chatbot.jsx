...
const Chatbot = () => {
  ...
  const getBotResponse = (message) => {
    ...
    if (lowerMessage.includes("some examples of your work"))
      return `You can check out my projects on my <a href="https://github.com/ZahraYasin2209" target="_blank" style="color:#3B2FC4; font-weight:bold; text-decoration: underline;">GitHub profile</a>.`;
    ...
    if (lowerMessage.includes("how can i contact you"))
      return `You can reach me via email at zahrayasin2209@gmail.com or through my LinkedIn profile <a href="https://www.linkedin.com/in/zahra-yasin-18b3a6246/" target="_blank" style="color:#3B2FC4; font-weight:bold; text-decoration: underline;">LinkedIn</a>.`;
